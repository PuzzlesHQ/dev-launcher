...
public class VersionCheckerCosmic {

    public static final URL vManifestUrl;

    static {
        try {
            vManifestUrl = new URL("https://raw.githubusercontent.com/PuzzlesHQ/CRArchive/refs/heads/main/versions.json");
        } catch (MalformedURLException e) {
            throw new RuntimeException(e);
        }
    }

    public static final File vManifest = new File(Main.base, "crarchive-version-manifest.json");
    public static final File refreshFile = new File(Main.base, "crarchive-version-manifest.json.refresh");
